...
<body>
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1>
                Kalo Mau Punya Duit, <br>
                Harus Siap Ngebantu <br>
              </h1>
              <p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              Lebih Dari 1000 PEKERJAAN kami selesaikan dari <br>
              customer yang telah MEMPERCAYAKAN DAN MEMILIH
              layanan SIAP BANTU
            </h2>
            <p>
              Kami siap bantu apapun yang customer laksanakan dengan cepat dan maksimal
            </p>
            <a href="">
              cari jasa SIAP BANTU
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              <h5>
                Mengubur bangkai hewan
              </h5>
              <p>
               Bantu kamu untuk mengubur hewan untuk anda yang takut
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Bantu kamu dalam men service barang electronik apapun
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Bantu kamu dalam hal membersihkan alat rumah tanggan apapun
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="client_section ">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          KATA MEREKA TENTANG SIAP BANTU
        </h2>
      </div>
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="c:\Users\Haikal\Downloads\sakiri-saat-melayani-pelanggannya-di-pelabuhanratu-sukabumi_169.jpeg" alt="">
                </div>
              ...
              <div class="client_text">
                <p>
                  Pengerjaan nya bagus,ac saya yang rusak bisa benar lagi setelah di kerjakan mas aceng mitra nya juga sopan
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="c:\Users\Haikal\Downloads\images (6).jpg" alt="">
                </div>
                <div class="client_detail">
                  <div class="client_info">
                    <h6>
              ...
              <div class="client_text">
                <p>
                  Terima kasih banyak buat jasa siap bantu, puas sama sistemnya kerjanya gercep mitanya juga baik dan sopan 
...
<script>src="/public/siap bantu/siap bantu/js/bootstrap.js"</script>
